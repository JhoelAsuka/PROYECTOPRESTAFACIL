        ...
        <div class="perfil-usuario-header">
          <div class="perfil-usuario-portada">
            <div class="perfil-usuario-avatar">
             <img src="../vista/img/name.svg" alt="">     <!--puede poner un img -->
             <button type="button" class="boton-avatar">
             <i class="fa-regular fa-image"></i>
             </button>
            </div>
            <button type="button" class="boton-portada" >
            <i class="fa-regular fa-image"></i> cambiar fondo
            </button>
          </div>
        </div>
        <div class="perfil-usuario-body">
          <div class="perfil-usuario-bio">
            <h3 class="titulo">Nombre de Usuario:  <?php echo $nombre; ?></h3>
          </div>
          <div class="perfil-usuario-footer">
            <ul class="lista-datos">
            <li class="icon-imagen"> <i class="fa-solid fa-user"></i> Apellido paterno:  <?php echo $apaterno; ?></li>
            <li class="icon-imagen"> <i class="fa-solid fa-user"></i> Apellido materno:  <?php echo $amaterno; ?></li>
            <li class="icon-imagen"> <i class="fa-solid fa-envelope"></i> Correo:  <?php echo $correo; ?></li>
            </ul>
            <ul class="lista-datos">
            <li class="icon-imagen"> <i class="fa-solid fa-house"></i> Direccion:  <?php echo $direccion; ?></li>
            <li class="icon-imagen"> <i class="fa-solid fa-phone"></i> Telefono:  <?php echo $telefono; ?></li>
            </ul>
          </div>
        </div>
      </section>
